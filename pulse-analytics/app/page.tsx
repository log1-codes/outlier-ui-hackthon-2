  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b bg-white px-4 md:px-6">
        <div className="flex items-center gap-2 font-semibold text-lg text-primary">Pulse Analytics</div>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Gain valuable insights, track performance, and make data-driven decisions with our comprehensive
                    analytics dashboard.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-center">
                <div className="relative h-[350px] w-full overflow-hidden rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 p-4 shadow-lg">
                  ...
                  <div className="relative z-10 flex h-full flex-col items-center justify-center space-y-4 rounded-lg border bg-white/80 p-6 shadow-sm">
                    <div className="w-full space-y-2">
                      <div className="h-4 w-3/4 rounded-full bg-primary/20"></div>
                      <div className="h-4 w-1/2 rounded-full bg-primary/20"></div>
                    </div>
                    <div className="grid w-full grid-cols-2 gap-4">
                      <div className="h-20 rounded-lg bg-primary/10"></div>
                      <div className="h-20 rounded-lg bg-primary/10"></div>
                    </div>
                    <div className="h-32 w-full rounded-lg bg-primary/10"></div>
                    <div className="h-20 w-full rounded-lg bg-primary/10"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our analytics dashboard provides comprehensive tools to help you understand your business performance
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Monitor your business performance in real-time with live data updates.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
                ...
                <p className="text-center text-muted-foreground">
                  Generate detailed reports to analyze trends and patterns in your data.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
                ...
                <p className="text-center text-muted-foreground">
                  Track user behavior and engagement to optimize your products and services.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  Personalize your dashboard to focus on the metrics that matter most to you.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    Pulse Analytics was founded with a mission to help businesses of all sizes harness the power of data
                    to drive growth and success.
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    Our team of data scientists and analytics experts have developed a powerful yet intuitive platform
                    that makes it easy to track, analyze, and visualize your business data.
                  </p>
                  <p className="text-muted-foreground">
                    Whether you're a small startup or a large enterprise, our analytics dashboard provides the insights
                    you need to make informed decisions and stay ahead of the competition.
                  </p>
                </div>
              </div>
              <div className="flex items-center justify-center">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>info@pulseanalytics.com</span>
                  </div>
                  <div className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>123 Analytics Street, San Francisco, CA 94107</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col space-y-4">
      ...
      <footer className="w-full border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          <p className="text-center text-sm leading-loose text-muted-foreground md:text-left">
            © 2023 Pulse Analytics. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
